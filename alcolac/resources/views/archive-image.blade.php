...
@section('content')
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-6">
          <div class="clearfix">
            <h1 class="float-left display-3 mr-4">Sorry!</h1>
            <h4 class="pt-3">That file isn't available.</h4>
            <p class="text-muted">Please contact management if you require this document.</p>
          </div>
