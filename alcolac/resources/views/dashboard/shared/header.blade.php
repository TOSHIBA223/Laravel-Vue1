      ...
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav ml-auto mr-4">
          ...
          <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              <div class="c-avatar"><img class="c-avatar-img" src="{{ env('APP_URL', '') }}/images/placeholderUser.png" alt="user@email.com"></div>
            </a>
            <div class="dropdown-menu dropdown-menu-right pt-0 pb-0">
              <div class="dropdown-header bg-light py-2">
{{--                  <strong>Account</strong></div><a class="dropdown-item" href="#">--}}
...
{{--                </svg>--}}
                  <form action="/admin/logout" method="POST"> @csrf <button style="margin-top: 0;" type="submit" class="btn btn-ghost-dark btn-block">Logout</button></form></a>
            </div>
          </li>
        </ul>
