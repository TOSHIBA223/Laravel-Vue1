...
?>
      ...
      <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" style="padding: 10px 0;" src="{{ env('APP_URL', '') }}/images/LambCoOld.png" width="80" alt="CoreUI Logo"><img class="c-sidebar-brand-minimized" src="assets/brand/coreui-signet-white.svg" width="118" height="46" alt="CoreUI Logo"></div>
        ...
        <button class="c-sidebar-minimizer c-class-toggler" type="button" data-target="_parent" data-class="c-sidebar-minimized" style="position: relative;">
            <span class="version-number text-white" style="position: absolute; left: 5px; top: 15px;">
                V{{env('APP_VERSION')}}
            </span>
        </button>
    </div>
