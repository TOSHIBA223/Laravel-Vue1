...
export default {
  ...
  methods: {
    ...
    deleteUser(id) {
      this.$inertia.delete("/admin/api/qr-codes/delete/" + id).then(() => {
    ...
    searchUsers(string) {
      this.$inertia
        .post("/admin/api/qr-checks/search", { search: string })
        .then(() => {
          this.templates = this.data.users.data;
          this.pagination = {
            current_page: this.data.users.current_page,
    ...
    enableUser(id) {
      ...
      this.$inertia.put("/admin/api/qr-codes/update", enableObj).then(() => {
        this.templates = this.data.users.data;
      });
    },
    addNew() {
